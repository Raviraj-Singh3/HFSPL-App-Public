...
import 'package:HFSPL/Review_Update_KYC_Photos/Rejected/rejected_members.dart';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onTapUp: (_) {
        ...
        Navigator.push(context, MaterialPageRoute(builder: (context) => RejectedMembers(groupdId: widget.group.groupId)));
        },
        onTapCancel: () {
          setState(() {
