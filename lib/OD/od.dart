...
class _ODPageState extends State<ODPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('OD Page')),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _odInfoRow("Total Amount Payable :", "₹${odResponse!.totalAmtPaybleOneDayBack}"),
                            _odInfoRow("Total Outstanding :", "₹${odResponse!.totalOSOneDayBack}"),
                            _odInfoRow("Total Members :", "${odResponse!.totalMembersOneDayBack}"),
        
                            const SizedBox(height: 12),
                            const Divider(thickness: 1),
        
                            _odInfoRow("Total Amount Payable (On Second Date):", "₹${odResponse!.totalAmtPaybleTwoDaysBack}"),
                            _odInfoRow("Total Outstanding (On Second Date):", "₹${odResponse!.totalOSTwoDaysBack}"),
                            _odInfoRow("Total Members (On Second Date):", "${odResponse!.totalMembersTwoDaysBack}"),
                          ],
                        ),
                      ),
                    ),
