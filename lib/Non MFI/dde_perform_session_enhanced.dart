...
class DDEPerformSessionEnhanced extends StatefulWidget {
  final int ddeScheduleId;
  final String memberName;
  final String scheduledDate;

  const DDEPerformSessionEnhanced({
    Key? key,
  ...
  @override
  State<DDEPerformSessionEnhanced> createState() => _DDEPerformSessionEnhancedState();
}

class _DDEPerformSessionEnhancedState extends State<DDEPerformSessionEnhanced> {
      ...
      if (pickedFile != null) {
        setState(() {
          if (isPassbook) {
            ...
            _passbookFileName = pickedFile.name;
          } else {
                        ...
                        [
                          TextField(
                            ...
                            decoration: const InputDecoration(
                              hintText: 'Enter training notes and observations...',
